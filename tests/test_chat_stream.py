...
def test_chat_stream_simple(provider: AIProvider, client_kwargs: dict, func_kwargs: dict):
...
@base_test_all_providers
def test_chat_stream_tools(provider: AIProvider, client_kwargs: dict, func_kwargs: dict):
